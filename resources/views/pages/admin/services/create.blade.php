    ...
    <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-5 border-b border-gray-100">
                ...
                <p class="text-sm text-gray-500 mt-1">Create a service to display on the homepage.</p>
            </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="excerpt"
                              ...
                              class="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#1a2f5e] focus:border-transparent transition">{{ old('excerpt') }}</textarea>
                    @error('excerpt')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <label for="imageInput"
                            ...
                            {{-- Placeholder --}}
                            <div id="imagePlaceholder" class="flex flex-col items-center gap-2 z-10">
                    ...
                    <div>
                        ...
                        <div class="mt-3 flex items-center gap-3">
                            <div class="w-14 h-14 rounded-full bg-[#1a2f5e] flex items-center justify-center shadow-lg shadow-[#1a2f5e]/20">
                                <i id="iconPreview" class="text-white text-2xl fa-solid fa-circle-question"></i>
                            </div>
                            <div>
                                <p class="text-xs font-semibold text-gray-500">Live preview</p>
                                <p class="text-xs text-gray-400">Icon will appear here</p>
                            </div>
                        </div>
...
<script>
    ...
    ClassicEditor
        ...
        .then(editor => {
            // Optional: Store editor instance for later use
