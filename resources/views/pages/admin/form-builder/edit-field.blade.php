...
<div class="max-w-7xl mx-auto">
    ...
    <form action="{{ route('admin.programs.form-builder.fields.update', [$program, $section, $field]) }}" method="POST">
        @csrf
        @method('PUT')
                ...
                <div class="bg-gradient-to-br from-[#061d43] via-[#102b5c] to-[#1a2f5e] rounded-3xl shadow-xl overflow-hidden sticky top-6">
                    <div class="p-7 text-white relative">
                        ...
                        <p class="text-sm text-white/70 mt-3 leading-relaxed">
                            Update field label, type, options, status and validation message for student application form.
                        </p>

                        <div class="mt-7 space-y-4">
                            <div class="bg-white/10 rounded-2xl p-4 border border-white/10">
                                <p class="text-xs text-white/50 mb-1">Current Field</p>
                                <h4 class="text-sm font-bold">{{ $field->label }}</h4>
                            </div>
                        ...
                        <div class="mt-7 border-t border-white/10 pt-5">
                            <ul class="space-y-3 text-sm text-white/75">
                                ...
                                <li class="flex items-center gap-3">
                                    <i class="fa-solid fa-circle-check text-[#dca737]"></i>
                                    Manage required and active status
                                </li>
                                <li class="flex items-center gap-3">
                                    <i class="fa-solid fa-circle-check text-[#dca737]"></i>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="px-7 py-5 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                        <div class="flex items-center justify-between gap-4">
                            <div>
                                <h2 class="font-black text-gray-800 text-lg">Edit Form Field</h2>
                                <p class="text-xs text-gray-400 mt-1">
                                    Changes will reflect on frontend application form.
                                </p>
                            </div>
                    ...
                    <div class="p-7">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="number" name="sort_order" value="{{ old('sort_order', $field->sort_order) }}" min="0"
                                    class="w-full px-4 py-3 border border-gray-200 rounded-2xl text-sm bg-gray-50/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#1a2f5e] focus:border-transparent transition">
                            </div>
                            ...
                            <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div class="rounded-2xl border border-gray-100 bg-gray-50/70 p-5">
                                    ...
                                    <label class="flex items-center justify-between cursor-pointer">
                                        ...
                                        <div class="relative">
                                            <input type="checkbox" name="is_required" id="is_required" class="sr-only peer" {{ old('is_required', $field->is_required) ? 'checked' : '' }}>
                                ...
                                <div class="rounded-2xl border border-gray-100 bg-gray-50/70 p-5">
                                    ...
                                    <label class="flex items-center justify-between cursor-pointer">
                                        ...
                                        <div class="relative">
                                            <input type="checkbox" name="is_active" id="is_active" class="sr-only peer" {{ old('is_active', $field->is_active) ? 'checked' : '' }}>
                    ...
                    <!-- <div id="store-in-system-section" class="hidden md:col-span-2">
                        <div class="rounded-2xl border border-gray-100 bg-gray-50/70 p-5">
                            ...
                            <div id="options-section" class="hidden md:col-span-2">
                                <div class="rounded-3xl border border-[#dca737]/20 bg-[#dca737]/5 p-5">
                                    ...
                                    <div id="options-list" class="space-y-2">
                                        @php
                                        $optionValues = old('options', $field->options ?? []);
                                        @endphp

                                        @if($optionValues && count($optionValues))
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="validation_message" value="{{ old('validation_message', $field->validation_message) }}"
                    ...
                    <div class="px-7 py-5 border-t border-gray-100 bg-gray-50 flex items-center justify-between">
                        ...
                        <button type="submit"
                            ...
                            <i class="fa-solid fa-save mr-1.5"></i> Update Field
                        </button>
                    </div>
